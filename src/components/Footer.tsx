...
const socialLinks = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/shaylevi/',
    icon: (props: any) => (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/shaylevi',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  {
    name: 'Dribbble',
    href: 'https://dribbble.com/shaylevi',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export default function Footer() {
  return (
    <footer className="bg-background border-t border-gray-100 dark:border-gray-800">
